...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~gpgFWYqa#ruJuHmjyyMuwOqwQeMgdbPOdmAgJpcRvUdkIBhFL0KY",
// add your Session Id 

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "✦TIGER xᴅ",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254798447940",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "TIGER",
// add bot owner name

DESCRIPTION: process.env.DESCRIPTION || "TIGER",
// add bot owner name    
...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "Ghost Vision",
